...
public class List_CourseTypes extends ArrayAdapter {
    Activity context;
    DatabaseReference refCourse;
    List<vl_coursetype> coursetypevals;
    public List_CourseTypes(Activity context, List<vl_coursetype> coursetypevals) {
        super(context, R.layout.ly_coursetypes,coursetypevals);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View ListViewItem = inflater.inflate(R.layout.ly_coursetypes,null, true);

        TextView txtcoursetypename =(TextView)ListViewItem.findViewById(R.id.txtcoursetypename);
        final TextView txtcoursetypecount = (TextView)ListViewItem.findViewById(R.id.txtcoursetypecount);
        ...
        refCourse.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                txtcoursetypecount.setText("ຫຼັກສູດທັງໝົດ: " + count);
            }
