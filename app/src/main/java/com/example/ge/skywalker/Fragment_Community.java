 ...
 * {@link Fragment_Community.OnFragmentInteractionListener} interface
...
public class Fragment_Community extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_fragment__community, container, false);
    }
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof OnFragmentInteractionListener) {
         ...
         //   Toast.makeText(context, "Community Fragment", Toast.LENGTH_SHORT).show();
        }
    }
